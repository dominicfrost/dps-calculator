...
public enum Prayer
{
	...
	PROTECT_FROM_MAGIC("Protect from Magic", PrayerGroup.UTILITY, 1f, 1.05f, 3),
	PROTECT_FROM_RANGED("Protect from Missiles", PrayerGroup.UTILITY, 1f, 1.05f, 3),
	PROTECT_FROM_MELEE("Protect from Melee", PrayerGroup.UTILITY, 1f, 1.05f, 3),
